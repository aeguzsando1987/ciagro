...
def validate_raw_data_against_scheme(parameters: dict, definition_scheme: dict) -> None:
    '''
    ...
    args:
        parameters: diccionario con los datos del csv
    ...
    # Resolver las keys de parameters a nombres canonicos
    resolved_keys = {alias_to_canonical.get(key, key) for key in parameters.keys()}
